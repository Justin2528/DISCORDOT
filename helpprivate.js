...
module.exports.run = async (bot, message, args) => {
  let helpprivate = new Discord.RichEmbed()
  ...
  .addField("Pickle useful|", "ping :white_check_mark:")
  ...
  .addField("Pickle Update|", "invitestats :white_check_mark:")
  ...
  message.author.send(helpprivate).then(message.react('✅'));
